...
for i,axi in enumerate(ax.flat):
    ...
    fig.suptitle('Predicted Name')
plt.show()

# print(classification_report(y_test,yfit,target_names=faces.target_names))

# plt.figure(figsize=(9,9))
# matrix=confusion_matrix(y_test,yfit)
# sb.heatmap(matrix.T,square=True, annot=True,fmt='d',cbar=False, cmap='viridis', xticklabels=faces.target_names, yticklabels=faces.target_names)
