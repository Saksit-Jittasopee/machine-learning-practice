...
plt.scatter(x_test[:,0],x_test[:,1], c="orange", s=120)
plt.scatter(centers[0,0], centers[0,1], c='red', label='Centroid 1')
plt.scatter(centers[1,0], centers[1,1], c='green', label='Centroid 2')
plt.scatter(centers[2,0], centers[2,1], c='black', label='Centroid 3')
plt.scatter(centers[3,0], centers[3,1], c='pink', label='Centroid 4')
